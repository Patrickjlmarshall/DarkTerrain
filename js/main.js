...
function createMap(){
    ...
    var apitoken = 'pk.eyJ1IjoicGF0cmlja2ptYXJzaGFsbCIsImEiOiJjbGJiOHdnOGQxYzliM3ZwbHk0d2l4MHozIn0.0yT_XJHmScgvhtkV9eT4Ew' //Enter your API Token - go to 'https://www.mapbox.com/install/' to yours */
    ...
    var customeBasemap = L.tileLayer(mbStyleUrl, {id: 'patrickjmarshall/clbb90haa000114p9md4y173y', token: apitoken,  attribution: mbAttr});
